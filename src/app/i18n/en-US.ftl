...
settings-install-notifications = Install notifications
enabled = Enabled
disabled = Disabled
...
sidebar-downloads = Most downloaded
sidebar-recent = Recent
sidebar-favorites = Favorites
see-all = See All
see-all-catalog = Browse all
see-all-back = Back to Home
btn-sort = Sort
btn-filter = Filter
all-catalogs = All
status-installed = { $count } installed
